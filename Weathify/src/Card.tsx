...
function Weather({weatherData}) {
    return (
        <>
            <Card className={'flex flex-col  items-center bg-[#32302D] h-[90%] mt-[22px] w-[22rem] md:w-96'}>
                <div className={'flex justify-center text-center mt-4 md:mt-16 '}>
                    ...
                    <p className={'font-light font-sans text-2xl'}>
                            {weatherData.name}
                        </p>
                </div>
                <div className={'flex flex-col text-center items-center'}>
                <img alt={'Weather'} className={' md:mt-4 size-48'} src={`/src/icons/${weatherData.weather && weatherData.weather[0].icon}.svg`}/>
                    ...
                    <div className={'flex flex-row md:mt-20 md:gap-x-10 mt-8 gap-x-6'}>
                        ...
                        <Bottom icon={<svg className={'size-11 mt-1.5 mr-2 place-self-start opacity-40'} xmlns="http://www.w3.org/2000/svg"
                                           viewBox="0 0 576 512">
                            <path fill="#ffffff"
